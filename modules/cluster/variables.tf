...
variable "taskdef_template" {
  default = "D:/DevOps/Academy/Demo2/Project/container-definitions/cb_application.json.tpl"
}
...
variable "app_image" {
  ...
  default = "174462142093.dkr.ecr.us-east-1.amazonaws.com/app-env:latest"
}
